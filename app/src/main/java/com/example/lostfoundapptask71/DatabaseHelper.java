...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "LostFoundDBTask71";
    ...
    // This methid is used to add the user input to the database
    public Boolean insertData(String item_Type, String item_Name, String item_Phone, String item_Description, String item_Date, String item_Location){
